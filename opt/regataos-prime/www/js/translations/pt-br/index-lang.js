...
$(document).ready(function() {
    ...
    //Unlock widgets
    $(".unlockwidgets-text").text("Bloquear widgets");
    $(".unlockwidgets-on").text("Widgets bloqueados");
    $(".unlockwidgets-off").text("Widgets desbloqueados");

    //AMD AMF
    $(".amf-text").text("Ativar o AMD AMF");
    $(".amf-on").text("AMD AMF ativado");
    $(".amf-off").text("AMD AMF desativado");
    ...
    $(".opengl-version").text("Versão da API OpenGL");
    $(".vulkan-version").text("Versão da API Vulkan");
    $(".kernel-version").text("Versão do Kernel Linux");
